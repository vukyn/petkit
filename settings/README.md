...
into whatever repository the plugin was installed for, which on a work machine is
a path nobody wants published. What belongs here is the id, the scope and the
